...
public class came extends AppCompatActivity implements Callback,
        OnClickListener {

    private SurfaceView surfaceView;
    private SurfaceHolder surfaceHolder;
    private Camera camera;
    private ImageButton captureImage,flipCamera,flashCameraButton,rec,gallery;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.captureImage:
                ...
                break;
            case R.id.gallery:
                openApp(came.this,"com.example.ngannguyen.camera720android");
                break;
            default:
                break;
        }
            ...
            public void onPictureTaken(byte[] data, Camera camera) {
                try {
                    ...
                    if (success) {
                        ...
                        Toast.makeText(came.this,"Save",Toast.LENGTH_SHORT).show();
                    } else {
                    ...
                    came.this.getContentResolver().insert(
    ...
    private void alertCameraDialog() {
        AlertDialog.Builder dialog = createAlert(came.this,
