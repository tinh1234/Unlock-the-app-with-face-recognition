...
public class RecognizeActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    private static String TAG = "Tinh";
    ...
    private void recognizeImage(Mat mat) {
        ...
        {
            Toast.makeText(getApplicationContext(), "Xin chào "+imagesLabels.get(label[0])+"", Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(this,came.class);
            this.startActivity(intent);
        }
        else
            Toast.makeText(getApplicationContext(), "Không được truy cập", Toast.LENGTH_SHORT).show();
        ...
        recogniz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!faces.empty()) {
                    ...
                    Toast.makeText(getApplicationContext(), "không tìm thấy mặt", Toast.LENGTH_SHORT).show();
            }
        });
    }
